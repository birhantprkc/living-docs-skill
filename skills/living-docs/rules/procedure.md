...
1. **Before coding:** read the relevant constitution and ADRs (`living-docs effective` gives the in-force view). Decisions there are not to be re-opened casually.
